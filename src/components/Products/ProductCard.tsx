...
const ProductCard: React.FC<ProductProps> = ({ product }) => {
  return (
    <div className="relative bg-white rounded-xl shadow-md overflow-hidden group transition-all duration-300 hover:shadow-lg cursor-pointer">
      {/* Image */}
      ...
      <div className=" w-full">
        <button className="w-full bg-green-800 text-white py-2 font-semibold group-hover:hidden">
          Add to Cart
        </button>
        <button className="hidden group-hover:block w-full bg-green-700 text-white py-2 font-semibold">
          View Details
        </button>
      </div>
    </div>
